...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        train_frames, train_frames_d,train_anno, meta_obj_train = dataset.get_frames(seq_id, train_frame_ids, seq_info_dict)
        test_frames,test_frames_d, test_anno, meta_obj_test = dataset.get_frames(seq_id, test_frame_ids, seq_info_dict)

        data = TensorDict({'train_images': train_frames,
                           'train_images_d': train_frames_d,
                           'train_anno': train_anno['bbox'],
                           'test_images': test_frames,
                           'test_images_d': test_frames_d,                           
