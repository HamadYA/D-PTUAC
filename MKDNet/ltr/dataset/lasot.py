...
class Lasot(BaseVideoDataset):
    ...
    def _get_frame(self, seq_path, frame_id):
        ...
        #print(frame.shape,frame_d.shape)
        return frame   
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        obj_class = self._get_class(seq_path)
        #frame_list,frame_list_d = [self._get_frame(seq_path, f_id) for f_id in frame_ids]
        frame_list = [self._get_frame(seq_path, f_id) for f_id in frame_ids]
        #print("gggggg",frame_list)
        #print("xxxxxx",frame_list_d)        
        #frame_list=[frame_list_all[0][0],frame_list_all[1][0],frame_list_all[2][0]]
        #frame_list_d=[frame_list_all[0][1],frame_list_all[1][1],frame_list_all[2][1]] 
