...
from ltr.dataset import Lasot, TrackingNet, MSCOCOSeq, Got10k, SOT
...
def run(settings):
    ...
    dataset_train = sampler.ATOMSampler([lasot_train,SOT_train], [1,1],
    ...
    dataset_val = sampler.ATOMSampler([SOT_val], [1], samples_per_epoch=500*settings.batch_size, max_gap=50,
    ...
    # Optimizer
    optimizer = optim.Adam(actor.net.bb_regressor.parameters(), lr=1e-4)
