...
# load pretrained model
    pretrainmodel_path='/home/ps/A-DIMP/pytracking/pytracking/networks/atom_default.pth'
    pretrainmodel = loading.torch_load_legacy(pretrainmodel_path)['net']
    usepretrain = updback = updcls = updbb = True
    
    #**************test*******************#
    #usepretrain = updback  = updbb = False    
    if usepretrain:
    ...
    net = ATOMnet(feature_extractor=backbone_net, bb_regressor=bb_regressor, bb_regressor_layer=['layer2', 'layer3'],
