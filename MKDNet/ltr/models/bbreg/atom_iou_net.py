...
class AtomIoUNet(nn.Module):
    ...
    def forward(self, feat1, feat2, bb1, proposals2):
        ...
        pred_iou,roi3t,roi4t = self.predict_iou(modulation, iou_feat, proposals2)
        return pred_iou.reshape(num_images, num_sequences, -1),roi3t,roi4t
