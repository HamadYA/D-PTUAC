...
class LTRTrainer(BaseTrainer):
    def __init__(self, actor, loaders, optimizer, optimizer_D, settings, lr_scheduler=None):
        """
        args:
        ...
        """
        super().__init__(actor, loaders, optimizer,optimizer_D, settings, lr_scheduler)

        self._set_default_settings()

        # Initialize statistics variables
        self.stats = OrderedDict({loader.name: None for loader in self.loaders})
        self.settings.env.tensorboard_dir = '/home/lcl/zhuyabin/pytracking-train-super/ltr/tensorboard'
    ...
    def cycle_dataset(self, loader):
        ...
        for i, data in enumerate(loader, 1):
            ...
            # forward pass
            loss, loss_D, stats = self.actor(data)
