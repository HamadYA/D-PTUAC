...
class EnvSettings:
    def __init__(self):
        ...
        self.otb_path = '/media/ps/979e1f8d-4a13-40bb-8041-7e2e3a9a0b21/SOT-TRAIN/SOT/'
        self.nfs_path = ''
        self.uav_path = ''
        self.tpl_path = ''
        self.vot_path = ''
        self.got10k_path = ''
        self.lasot_path = '/media/ps/979e1f8d-4a13-40bb-8041-7e2e3a9a0b21/LaSOTTest/'
        ...
        self.sot_path = '/media/ps/979e1f8d-4a13-40bb-8041-7e2e3a9a0b21/SOT-TRAIN/'
