    ...
    if mode == 'sequential':
        ...
        for seq in dataset:
            for tracker_info in trackers:
                ave_iou, fps=run_sequence(seq, tracker_info, debug=debug, visdom_info=visdom_info)
                i=i+1
                if i==1:
                    ave_iou_all=ave_iou
                    fps_all=fps
                else:
                    ave_iou_all=ave_iou_all+ave_iou
                    fps_all=fps_all+fps
                print("ave_iou_all,fps_all",ave_iou_all/i,fps_all/i)
