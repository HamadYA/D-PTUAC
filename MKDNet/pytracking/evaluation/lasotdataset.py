...
class LaSOTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        occlusion_label_path = os.path.join(self.base_path, sequence_name,'full_occlusion.txt')
        ...
        out_of_view_label_path = os.path.join(self.base_path, sequence_name,'out_of_view.txt')        
        ...
        frames_path = os.path.join(self.base_path, sequence_name,'img')
