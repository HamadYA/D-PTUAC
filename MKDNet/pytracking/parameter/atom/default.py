...
def parameters():
    ...
    net_path='/home/ps/train-dimp/pytracking/ltr/checkpoints/ltr/bbreg/atom/ATOMnet_ep0030.pth.tar'
    deep_feat = deep.ATOMResNet18(net_path=net_path, output_layers=['layer3'], fparams=deep_fparams, normalize_power=2)
