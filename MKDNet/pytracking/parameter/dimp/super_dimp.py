...
def parameters():
    ...
    net_path='/home/user/zhuyabin/pytracking-tot2-gan-att-refine2/ltr/checkpoints/ltr/dimp/super_dimp/DiMPnet_ep0030.pth.tar'
    #net_path='/home/lcl/zhuyabin/pytracking/ltr/networks/super_dimp.pth.tar'
